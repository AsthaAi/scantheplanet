...
export const SYSTEM_PROMPT = `You are a security code analyzer for MCP (Model Context Protocol) servers.
...
export const BATCH_SYSTEM_PROMPT = `You are a security code analyzer for MCP (Model Context Protocol) servers.
...
IMPORTANT: Return empty findings array [] if no issues found. Do not fabricate findings.
Do not flag documentation or example-only files unless they expose a real server/tool path.`;
export const JSON_PREFILL = `{"findings":[`;
